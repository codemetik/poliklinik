                ...
                <div class="col-sm-3">
                    ...
                    <div class="form-groupm">
                        ...
                        <select class="form-control" name="id_bagian">
                            <?php 
                            $bg = mysqli_query($koneksi, "SELECT * FROM tb_bagian WHERE id_bagian != 'BG003' AND id_bagian != 'BG004'");
                            while ($dbg = mysqli_fetch_array($bg)) {
                                if ($data['id_bagian'] == $dbg['id_bagian']) {
                                    $select = "selected";
                                }else{
                                    $select = "";
                                } 
                                echo "<option value='".$dbg['id_bagian']."' ".$select.">".$dbg['nama_bagian']."</option>";
                            }
                            ?>
                        </select>
                    </div>
